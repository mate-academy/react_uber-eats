       ...
       <img
        ...
        <div>
          ...
          <div className="basket__basket-items-list">
            {basket && basket.map((item: basket) => (
              <div
                key={item.id}
                className="basket-items-list__basket-item"
              >
                <div className="wrapper">
                    <div
                      className="basket-item__counter"
                    >
                    <img
                      ...
                      />
                      <span className="basket-item__counter--counter">{item.count}</span>
                      <img
                        className="basket-item__counter--button"
          ...
          <div
            ...
            <span className="submit-block__submit--count">
              {basket!.length === 1
                ? basket![0].count
                : basket!.reduce((totalCount: number, basketItem: basket) =>
                  totalCount + basketItem.count, 0)}
            </span>
            <span>
              Total Price
            </span>
