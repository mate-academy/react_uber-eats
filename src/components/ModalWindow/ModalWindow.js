    ...
    <div className="modal-window__container modal-window">
      <div className="modal-window__content menu">
        ...
        <div className="menu__title-wrapper">
          ...
          <p className="menu__text-grey">Cheddar cheese, Boston lettuce, tomatoes, onion, pickles and firm sauce 275 g.</p>
        </div>

        <div className="menu__background">
          <h3 className="menu__text-black">Double Meat</h3>
          <p className="menu__text-grey">Choose up to 1</p>
        </div>
        <div className="menu__points point">
          ...
          <p className="point__price">+£0.68</p>
        </div>

        <p className="menu__text-black menu__background">Special instructions</p>
        <textarea className="menu__textarea" placeholder="Leave a note to kitchen" name="modal" id="" cols="30" rows="10" />
