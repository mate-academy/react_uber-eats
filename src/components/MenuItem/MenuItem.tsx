...
const MenuItem = ({
  ...
  const addToBasket = (
    ...
    if (
      (basket[0] && basket[0].restaurantTitle === restaurant.title) ||
      basket.length === 0 ||
      hasWarning
    ) {
      addItemToBasket(
  ...
  useEffect(() => {
    ...
    if (isEditable) {
      setCounter(
        basket && basket.find(elem => elem.itemUuid === menuItem.uuid)!.count,
      );
      setaddPrice(
        basket && basket.find(elem => elem.id === basketItemId)!.customInfo,
      );
    }
  ...
  if (hasError) {
    return (
      ...
      >
        <div className="error-message" ref={modalRef}>
  ...
  return (
    menuItem && (
      ...
      >
        <div className="form" ref={modalRef}>
          <div className="menu-item">
            ...
            <div className="menu-item__title-block">
              <h1 className="title-block__title">{menuItem.title}</h1>
              <p className="title-block__description">
                {menuItem.itemDescription}
              </p>
            </div>
            <div className="menu-item__customization-block">
              {menuItem.customizationsList &&
                menuItem.customizationsList.map(
                  (sublist: Customization, i: number) => (
                              ...
                              <label className="customization-block__items--lable">
                                ...
                                <div className="customization-block__items--name-price">
                                  ...
                                  <span className="customization-block__items--price">
                                    ...
                                    {(parseFloat(option.price) / 100).toFixed(
                                      2,
                                    )}
                                  </span>
                                </div>
            ...
            <div className="menu-item__submit-block">
              <div className="submit-block__quantity">
                ...
                <div className="submit-block__quantity--buttons">
                  ...
                  />
                  <div className="submit-block__quantity--buttons--counter">
                    {counter}
                  </div>
                  <img
