...
const mapDispatchToProps = (
  ...
  setHasWarning: (hasWarning: boolean) => dispatch(setHasWarning(hasWarning)),
  ...
  setCustomPrice: (
    ...
    customItem: string,
    uuid: string,
  ) => dispatch(setCustomPrice(price, subtitle, type, customItem, uuid)),
...
const connectedMenuItem = connector(MenuItem);
