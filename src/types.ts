...
export interface IMenuItemState extends IRestaurant {
  imageUrl: string;
...
export type Thunks<ReturnType = void> = ThunkAction<
  ReturnType,
  RootState,
  unknown,
  Action<string>
...
export type debounce = {
  (f: (...args: any[]) => any, delay: number): any;
};
